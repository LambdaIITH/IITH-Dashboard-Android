...
//        });
        ...
        ListView listView = (ListView) view.findViewById(R.id.listmonday);
        listView.setAdapter(itemsAdapter);

        ImageView home=(ImageView) view.findViewById(R.id.mondayedit);
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent homeIntent = new Intent(getActivity(),MondayAddActivity.class);
